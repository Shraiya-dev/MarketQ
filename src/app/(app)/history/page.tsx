...
import { Loader2, FileText, PlusSquare } from "lucide-react";
...
export default function PostHistoryPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title="Your Posts"
        description="Manage and review your posts across different stages: Drafts, In Review, and Ready to Publish."
        icon={FileText}
        actions={
